"use client";
import { Apple, BarChart, Bell, Brain, Lightbulb, Moon, Trophy } from "lucide-react";
...
const TIPS = [
  ...
  { icon: Bell, title: "Notifications vs alerts", tip: "Browser notifications are fine — they bring you back. But site-visit alerts (like Tab Time Tracker's limit warnings) are 3× more effective at reducing overuse than app-level blocks.", tag: "Tip" },
  ...
  { icon: BarChart, title: "Your data stays local", tip: "Tab Time Tracker never sends your browsing data to any server. It lives in your browser's local storage. You own it — export as CSV or JSON any time.", tag: "Privacy" },
];
  ...
  return (
    <section className="relative py-20 section-violet overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="text-5xl mb-4 flex items-center justify-center" style={{ color: "var(--violet-500)" }}>
            <Icon className="text-violet-500 text-center " />
          </div>
          <div
