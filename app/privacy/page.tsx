  ...
  return (
    <div className="min-h-screen bg-ink-950 px-6 py-20">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="font-display font-extrabold text-4xl  mb-2">Privacy Policy</h1>
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-8  leading-relaxed">
          <section>
            <h2 className="font-display font-semibold text-xl  mb-3">1. Overview</h2>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl  mb-3">2. Extension data</h2>
            <p>The Tab Time Tracker browser extension stores all data <strong className="">locally</strong> in Chrome's <code className="text-violet-300 bg-ink-800 px-1.5 py-0.5 rounded text-xs">chrome.storage.local</code>. This includes:</p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl  mb-3">3. Website data (this site)</h2>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl  mb-3">4. Cookies</h2>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl  mb-3">5. Children's privacy</h2>
            <p>Our extension and website are not directed to children under 13. We do not knowingly collect data from children.</p>
          </section>

          <section>
            <h2 className="font-display font-semibold text-xl  mb-3">6. Changes</h2>
